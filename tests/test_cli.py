...
class TestCli:
    ...
    def test_remove_duplicate_playlists(self, yt_browser: YTMusic, create_duplicate_playlists):
        runner = CliRunner()
        # Verify that we have 3 playlists with the same name
        ...
        assert track_count == 5, f"Expected remaining playlist to have 5 songs, but it has {track_count}"
